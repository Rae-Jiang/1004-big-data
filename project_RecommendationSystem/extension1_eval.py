...
def main(spark, val_data_file, model_file, strategy):
	'''
    Args
    -------
    val_data_file:
    ...
    # Transformation on count
    ratingCol = 'count'
    if strategy == 'log':
        val = val.withColumn("log_count",log("count"))
        ratingCol = "log_count"
...
if __name__ == "__main__":
    ...
    main(spark, val_data_file, model_file, strategy)
